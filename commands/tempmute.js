...
module.exports = {
    run: async (message, args) => {
        ...
        .setTitle(`<:mute:768082142646894593> ${member.user.tag} a été mute pendant ${humanizeDuration(duration, {language: 'fr'})} !`)
        ...
        setTimeout(() => {
            ...
            message.channel.send(new Discord.MessageEmbed()
            .setTitle(`<:mute:768082142646894593> ${member.user.tag} a été unmute.`) 
            .setColor("RANDOM")
)
        }, duration)
    },
